...
function sessionTest() {
  ...
  if (confSession.selectedIndex === -1) {
    // FIXME: setValidity -> setCustomValidity
...
function calcCart() {
  ...
  ); // FIXME: add { } to the second parameter
}
