...
function generateWordFreq(inputFile, outputDoc, outputCount) {
  ...
  // FIXME: Reader() -> FileReader(), read() -> readAsText()
  ...
  fr.onload = function () {
    ...
    // TODO: add global flag 'g' to the regex
    ...
    for (let i = 1; i <= 15; i++) {
      ...
      // FIXME: switch position of freqs and totalWords
