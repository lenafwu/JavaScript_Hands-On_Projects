...
document.getElementById("button0").onclick = function () {
  runCalculator("0"); // FW: Changed arg int 0 to string "0", otherwise won't work :)
};
...
function runCalculator(character) {
  ...
  // FW: Automatically scroll to the bottom of the calc window.
  document.getElementById("calcWindow").scrollTop =
    document.getElementById("calcWindow").scrollHeight;
}
