...
// FIXME: 4a. onkeypress -> addEventListener
...
function selectLetter(e) {
  ...
  // FIXME: 4c. e.code-> e.code == "Space" ? e.code : e.key;
  let userKey = e.code == "Space" ? e.code : e.key;
